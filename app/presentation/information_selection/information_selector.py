"""
InformationSelector — preserves structured semantic evidence.
Focal claim is NOT excluded from semantic_units (callers may require overlap).
Planner-level dedup removes visible duplicates.
"""
